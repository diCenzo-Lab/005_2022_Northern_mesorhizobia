...
nohup roary -p 2 -f Roary_output_90 -i 90 -g 500000 Genome_files/*.gff &
nohup roary -p 2 -f Roary_output_80 -i 80 -g 500000 Genome_files/*.gff &
nohup roary -p 2 -f Roary_output_70 -i 70 -g 500000 Genome_files/*.gff &
nohup roary -p 2 -f Roary_output_60 -i 60 -g 500000 Genome_files/*.gff &
nohup roary -p 2 -f Roary_output_50 -i 50 -g 500000 Genome_files/*.gff &
nohup roary -p 2 -f Roary_output_40 -i 40 -g 500000 Genome_files/*.gff &
wait
...
grep -v 'zhangyense' unique_counts.txt > temp.txt
mv temp.txt unique_counts.txt
