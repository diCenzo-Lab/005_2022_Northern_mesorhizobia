...
# Construct pangenome
roary -p 24 -f Roary_output -e -n -i 70 -g 150000 Genome_files/*.gff # Run roary
...
cd Phylogeny/
raxmlHPC-HYBRID-AVX2 -T 24 -s core_gene_alignment_trimmed.aln -N autoMRE -n core_gene_phylogeny -f a -p 12345 -x 12345 -m GTRCAT
cd ../
